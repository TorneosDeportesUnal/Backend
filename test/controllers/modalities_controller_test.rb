...
class ModalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modality" do
    assert_difference('Modality.count') do
      post modalities_url, params: { modality: { discipline: @modality.discipline, gender: @modality.gender } }, as: :json
    end
  ...
  test "should update modality" do
    patch modality_url(@modality), params: { modality: { discipline: @modality.discipline, gender: @modality.gender } }, as: :json
    assert_response 200
  end
