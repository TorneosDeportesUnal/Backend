...
class PlayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player" do
    assert_difference('Player.count') do
      post players_url, params: { player: { age: @player.age, career: @player.career, contact_emergency_name: @player.contact_emergency_name, contact_emergency_phone: @player.contact_emergency_phone, contact_phone: @player.contact_phone, document: @player.document, document_type: @player.document_type, email: @player.email, eps: @player.eps, first_name: @player.first_name, gender: @player.gender, last_name: @player.last_name, semester: @player.semester } }, as: :json
    end
