...
while i<50
	...
	Modality.create(id: i,gender: "masculino", discipline: "futbol")
	Modality.create(id: i+50, gender: "femenino", discipline: "basquet")
	...
	Prize.create(id: i, name:Faker::Pokemon.name, team_id: i, tournament_id: i)
